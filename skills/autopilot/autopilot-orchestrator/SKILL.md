...
当所有 Phase 1 issue 处理完毕（无 ready-for-agent 剩余），执行 `references/meta-review.md` 中的全局审查流程：并行派遣 reviewer 子 agent + orchestrator 自主审查，合并报告，修复 Critical/Important 问题，解析 PRD。
