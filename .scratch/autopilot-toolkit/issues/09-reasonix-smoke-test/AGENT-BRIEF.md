...
4. Invoke one upstream skill (e.g., `/diagnose` or `/caveman`)
5. Invoke one autopilot inline skill (e.g., `/audit-autopilot`)
6. Verify autopilot subagent skills appear with the `[subagent]` tag in the skill index
