...
Convert the existing `audit-autopilot` skill from opencode format to reasonix-compatible format. Copy the skill directory from `opencode-toolbox/skills/audit-autopilot/` to `skills/autopilot/audit-autopilot/`, then:
...
- [ ] The original `opencode-toolbox/skills/audit-autopilot/` remains unchanged
